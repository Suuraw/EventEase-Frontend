...
function Home() {
  ...
  return (
    <>
      ...
      <Sidebar />
      <Navbar />
      <div className="min-h-screen flex justify-center items-center relative md:mt-2">
        <motion.div
        ...
        >
          ...
          <div className="md:absolute left-10 top-10 sm:top-2">
            <motion.h1 className="text-4xl font-extrabold text-blue-500 flex flex-wrap">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:mt-8 ">
            <motion.img
              src={cloud}
            ...
            <motion.div
              className="md:absolute md:top-[50%] flex flex-col justify-center"
              initial={{ opacity: 0, y: 50 }} // Start from bottom
              animate={{ opacity: 1, y: 0 }} // Move upwards
              transition={{ duration: 1, delay: 0.3 }}
            >
      ...
      <section className="py-10 overflow-hidden relative">
        ...
        >
          ...
          {[...events, ...events].map((event, index) => (
            <motion.div
              key={index}
              className="w-60 h-40 bg-cover bg-center rounded-lg flex items-center justify-center text-lg font-semibold text-white cursor-pointer relative shadow-lg"
